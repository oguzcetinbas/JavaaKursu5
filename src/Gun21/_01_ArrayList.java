...
public class _01_ArrayList {
    ...
    public static void main(String[] args) {
        ...
        isimler.add("Ahmet");// uzunluk 1 , index 0
        isimler.add("Metin");// uzunluk 2 , index 1
        isimler.add("Hacer");// uzunluk 3 , index 2
        isimler.add("Aynur");// uzunluk 4 , index 3

        System.out.println("isimler = " + isimler);
        System.out.println("isimler.size() = " + isimler.size());

        isimler.add(1,"Muhammed"); // verilen index e ekliyor,diğerleri 1 kayıyor aşağıya doğru.
        System.out.println("isimler = " + isimler);
